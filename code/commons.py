...
# def query_hf_model(user_prompt,system_prompt="You are a helpful assistant."):
#     response = requests.post(
#         "http://localhost:7000/generate",
#         json={
#             "prompt": user_prompt,
...
# def query_hf_model(model, tokenizer, agent_context, max_tokens=512, n_repetitions=1):
#     """Query a local API endpoint with formatted context"""
#     responses = []
#     for _ in range(n_repetitions):
#         # Format the context into a prompt and system message
#         system_message = ""
#         prompt_parts = []
...
def load_model_tokenizer(model_name, device_map="auto"):
    ...
    #     )
    # model = AutoModelForCausalLM.from_pretrained("/tos-bjml-ma4tool/shared/MA4Tool/hug_ckpts/Qwen2.5-7b-instruct")
    # tokenizer = AutoTokenizer.from_pretrained("/tos-bjml-ma4tool/shared/MA4Tool/hug_ckpts/llama3-8b-instruct")
    tokenizer = AutoTokenizer.from_pretrained("/tos-bjml-ma4tool/shared/MA4Tool/hug_ckpts/Qwen2.5-7b-instruct")
    model = AutoModelForCausalLM.from_pretrained(
        "/tos-bjml-ma4tool/shared/MA4Tool/hug_ckpts/Qwen2.5-7b-instruct",
        # "/tos-bjml-ma4tool/shared/MA4Tool/hug_ckpts/llama3-8b-instruct",
        torch_dtype=torch.bfloat16,
        device_map="auto"
    )
